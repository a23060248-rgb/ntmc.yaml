Codex, act only as EXTERNAL_COMPATIBILITY_REVIEWER for review generation R1.
...
C:/Users/a2306/Desktop/code/ntmc.yaml/輕軌系統/.codex/tasks/GOV-MAGP-SOURCE-SCOPE-INDEPENDENT-REVIEW-PREPARATION-01/review-packages/compatibility-review/absolute-launch-envelope.json
...
Review only the requirements assigned to EXTERNAL_COMPATIBILITY_REVIEWER. Do not perform another Reviewer's role, approve source authority, approve MAGP architecture, start Architecture Reconciliation, create a Core Object Library, run the Aggregator, or alter evidence.
