# A11 Security Review — Standalone Top-Level Reviewer Prompt

Execute only in a brand-new top-level Codex chat. Do not create child agents. Act only as security_review. Do not write, use Git, start services, access databases, seeds, migrations, or product operations.

1. Read the launch envelope only from its exact absolute path: C:/Users/a2306/Desktop/code/ntmc.yaml/輕軌系統/.codex/tasks/GOV-PHASE1-SESSION-A11-NEW-CANDIDATE-REVIEW-PREPARATION/review-packages/security-review/reviewer-launch-envelope.json
