...
<!-- 本檔每個 session 都載入，是最貴的不動產。只放：環境事實、五條硬規則、路由表。
     長內容一律放 refs/，需要時才讀。改本檔前先備份：cp AGENTS.md AGENTS.md.bak-<日期>
     若本 repo 原本已有 AGENTS.md：先照 refs/00-diagnosis.md 首次落地程序第 4 步審計合併，不要直接覆蓋。 -->
...
| 想改 AGENTS.md 或 refs/ 任何檔、踩坑後要記教訓 | `refs/40-maintenance.md` |
